...
if ENV:
    ...
    class Config(object):
        ...
        TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "RezalBot")
        ...
        UPSTREAM_REPO = os.environ.get(
            "UPSTREAM_REPO", "https://github.com/RezalBotOP/RezalBot"
        )
        ...
        EXTRA_REZALBOT = os.environ.get("EXTRA_REZALBOT", -1001221881562)
